...
random_forest_accuracy_counts = metrics.accuracy_score(predictions, test_labels)
random_forest_precision_counts = metrics.precision_score(predictions, test_labels)
random_forest_recall_counts = metrics.recall_score(predictions, test_labels)
random_forest_f1_counts = metrics.f1_score(predictions, test_labels)
random_forest_auc_counts = metrics.roc_auc_score(predictions, test_labels)
